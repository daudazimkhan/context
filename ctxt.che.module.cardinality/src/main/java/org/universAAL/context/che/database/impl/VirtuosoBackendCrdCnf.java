...
import org.universAAL.context.rdf4j.sail.CardinalityStore;

/**
 * Like a {@link org.universAAL.context.che.database.impl.VirtuosoBackendCrd} that
 ...
 *
 */
public class VirtuosoBackendCrdCnf extends VirtuosoBackendWithConfidence {
	/**
	 * Logger.
	 */
	private static final Log log = Hub.getLog(VirtuosoBackendCrdCnf.class);

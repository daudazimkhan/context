...
import org.universAAL.context.rdf4j.sail.CollectionStore;
 ...
 *
 */
public class VirtuosoBackendCrdClc extends VirtuosoBackend {
	/**
	 * Logger.
	 */
	private static Log log = Hub.getLog(VirtuosoBackendCrdClc.class);
